<!-- Legacy token management UI retained for historical reference.
     Active token management lives in src/views/TokenImport/index.vue backed by src/stores/tokenStore.ts. -->
<template>
  <a-card>
    <template #extra>
