// Legacy token manager retained for backwards compatibility with older profile tooling.
// The actively maintained token source of truth is `src/stores/tokenStore.ts`.
