...
test('cron uses standard OR semantics when both day-of-month and weekday are restricted', () => {
  const now = new Date('2026-08-31T16:00:00.000Z');
  assert.equal(calculateNextRunAt('0 8 1 * 1', now), '2026-09-01T00:00:00.000Z');
});
